...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_miryoku(
    ...
    U_NP,              U_NP,              LT(MEDIA, KC_BSPC), LT(NAV, KC_SPC),   LT(MOUSE, KC_TAB), LT(SYM, KC_ENT),   LT(NUM, KC_BSPC),  LT(FUN, KC_DEL),   U_NP,              U_NP
  ),
  [NAV] = LAYOUT_miryoku(
  ...
  [MOUSE] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_BSPC,   U_MAX,    KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,
